...
Fecha: 17/03/2023
Nombre de archivo: CNN_CD29
Descripcion: Modelo de clasificacion del CD29 el cual utiliza una red neuronal convulsional de 2 capas ocultas y 1 de salida
Version: 1.0
'''
...
from recorte_cd29 import recortar
import cv2
import numpy as np
...
modelo.fit(x_train, y_train, batch_size=32, epochs=8, validation_data=(x_test, y_test))
#------ENTRENAMIENTO DE LA RED------

#------CARGA DE LAS IMAGENES A CLASIFICAR------
path = r'2.jpg'
I = cv2.imread(path)
#------RECORTE DE LA ZONA DEL REACTIVO DE LAS IMAGENES A CLASIFICAR------
I = recortar(I)
#------RECORTE DE LA ZONA DEL REACTIVO DE LAS IMAGENES A CLASIFICAR------
cv2.imshow('recorte',I)
cv2.waitKey()
