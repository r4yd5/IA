...
Fecha: 17/03/2023
Nombre de archivo: CD40
Descripcion: Modelo de clasificacion del CD40 el cual utiliza un recorte automatico de la zona del reactivo
Version: 1.0
'''
...
def caracteristicas(img):
    ...
    m,n,_ = img.shape
    recorte = img[:,np.uint64(0.86*n):]
    
    canny = cv2.Canny(recorte,0,100) 
...
path = r"C:\Users\Juan Manuel Sanchez\Desktop\CD40\test\R/"
